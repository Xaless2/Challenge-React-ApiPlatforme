      ...
      <div className="background ">
        <div className="container">
          <div className="flex flex-col p-2 py-6 m-h-screen">
            <h1
              className="text-3xl font-bold text-center text-white mt-48 ml-24"
              style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)" }}
            >
              Trouvez un coach sportif près de chez vous
            </h1>
            <p
              className="text-center text-white ml-24 underline decoration-sky-500"
              style={{ textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)" }}
            >
            ...
            <RevealOnScroll>
              <div
                className="items-center justify-between  flex shadow-lg p-2 mb-5 sticky"
                style={style}
              >
                <div>
