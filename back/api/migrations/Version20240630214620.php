 ...
 */
final class Version20240630214620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE brand (id INT NOT NULL, user_id INT NOT NULL, display_name VARCHAR(255) NOT NULL, kbis_pdf VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, coach_id INT NOT NULL, client_id INT NOT NULL, number_of_stars INT NOT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_794381C63C105691 ON review (coach_id)');
        ...
        $this->addSql('CREATE TABLE slot_coach (id INT NOT NULL, slot_id_id INT NOT NULL, coach_id_id INT NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_51EC428111F1B11A ON slot_coach (slot_id_id)');
        $this->addSql('CREATE INDEX IDX_51EC42816BC6FD7D ON slot_coach (coach_id_id)');
        ...
        $this->addSql('ALTER TABLE review ADD CONSTRAINT FK_794381C63C105691 FOREIGN KEY (coach_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE review ADD CONSTRAINT FK_794381C619EB6921 FOREIGN KEY (client_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE slot_coach ADD CONSTRAINT FK_51EC428111F1B11A FOREIGN KEY (slot_id_id) REFERENCES slot (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE slot_coach ADD CONSTRAINT FK_51EC42816BC6FD7D FOREIGN KEY (coach_id_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review DROP CONSTRAINT FK_794381C63C105691');
        ...
        $this->addSql('ALTER TABLE slot_coach DROP CONSTRAINT FK_51EC428111F1B11A');
        $this->addSql('ALTER TABLE slot_coach DROP CONSTRAINT FK_51EC42816BC6FD7D');
        ...
        $this->addSql('DROP TABLE slot_coach');
