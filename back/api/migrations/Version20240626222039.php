 ...
 */
final class Version20240626222039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE member (id INT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, phone VARCHAR(20) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, zipcode VARCHAR(20) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) NOT NULL, text TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE slot_user (slot_id INT NOT NULL, coach_id INT NOT NULL, PRIMARY KEY(slot_id, coach_id))');
        $this->addSql('CREATE INDEX IDX_53BA7CDE59E5119C ON slot_user (slot_id)');
        $this->addSql('CREATE INDEX IDX_53BA7CDE3C105691 ON slot_user (coach_id)');
        ...
        $this->addSql('ALTER TABLE slot_user ADD CONSTRAINT FK_53BA7CDE59E5119C FOREIGN KEY (slot_id) REFERENCES slot (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE slot_user ADD CONSTRAINT FK_53BA7CDE3C105691 FOREIGN KEY (coach_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE slot_user DROP CONSTRAINT FK_53BA7CDE3C105691');
