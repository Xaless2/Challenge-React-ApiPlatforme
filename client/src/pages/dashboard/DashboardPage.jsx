    ...
    >
      <div>
        ...
        <div className="mt-8 text-center">
          ...
          />
          <h5 className="mt-4 hidden text-xl font-semibold text-black lg:blocktext-black">Cynthia J. Watts</h5>
        ...
        <ul className="mt-8 space-y-2 tracking-wide">
          <li>
            <a
              ...
              className="relative flex items-center space-x-4 rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-black"
            >
          ...
          <li>
            ...
            >
              ...
              <span className="group-hover:text-black">Categories</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="group-hover:text-black">Reports</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span className="group-hover:text-black text-black">Finance</span>
            </a>
          </li>
        </ul>
      </div>
        ...
        <div className="flex items-center justify-between space-x-4 px-6 2xl:container">
          ...
          <div className="flex space-x-4">
            ...
            <div hidden className="md:block">
              <div className="relative flex items-center text-black focus-within:text-cyan-400">
                ...
                <input
                  ...
                  className="outline-none w-full rounded-xl border border-gray-300 py-2.5 pl-14 pr-4 text-sm text-black transition focus:border-cyan-300 dark:bg-gray-900 dark:border-gray-700"
                />
              </div>
            </div>
            {/* <!--/search bar --> */}
            ...
            >
              <svg
                xmlns="http://ww50w3.org/2000/svg"
                className="mx-auto w-4 fill-current text-blacktext-black"
                viewBox="0 0 35.997 36.004"
              >
                <path
                  id="Icon_awesome-search"
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="m-auto h-5 w-5 text-blacktext-black"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
      ...
      <div className="px-6 pt-6 2xl:container">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="md:col-span-2 lg:col-span-1">
            <div className="h-full space-y-6 group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 bg-opacity-50 shadow-2xl shadow-gray-600/10">
              <svg
              ...
              <div>
                <h5 className="text-center text-xl text-black ">Global Activities</h5>
                <div className="mt-2 flex justify-center gap-4">
                  <h3 className="text-3xl font-bold text-black ">$23,988</h3>
                ...
                <span className="block text-center  dark:text-black">Compared to last week $13,988</span>
              </div>
              <table className="w-full text-black dark:text-black">
                <tbody>
                  <tr>
                    <td className="py-2">Tailored ui</td>
                    <td className="text-black">896</td>
                    <td>
                      <svg
                  ...
                  <tr>
                    ...
                    <td className="text-black">1200</td>
                    <td>
                      <svg
                        className="ml-auto w-16"
                        viewBox="0 0 68 21"
          ...
          <div>
            <div className="h-full group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 bg-opacity-50 shadow-2xl shadow-gray-600/10">
              <h5 className="text-xl  text-black">Downloads</h5>
              <div className="my-8">
                <h1 className="text-5xl font-bold text-black text-black">64,5%</h1>
                <span className="text-black dark:text-black">Compared to last week $13,988</span>
              </div>
              <svg
                className="w-full"
                viewBox="0 0 218 69"
              ...
              <table className="mt-6 -mb-2 w-full text-black">
                <tbody>
          ...
          <div>
            <div className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
              <svg
              ...
              <div className="mt-6">
                <h5 className="text-center text-xl text-blacktext-black">Ask to customize</h5>
                <div className="mt-2 flex justify-center gap-4">
                  <h3 className="text-3xl font-bold text-black text-black">28</h3>
                  <div className="flex items-end gap-1 text-green-500">
                    <svg
                      className="w-3"
                      viewBox="0 0 12 15"
                ...
                <span className="block text-center text-black">Compared to last week 13</span>
              </div>
              <table className="mt-6 -mb-2 w-full text-blacktext-black">
                <tbody>
                  <tr>
                    <td className="py-2">Tailored ui</td>
                    <td className="text-black">896</td>
